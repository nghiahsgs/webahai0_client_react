    ...
    render() { 
        ...
        return ( 
            <div className="container">
                <h2 className="text-center">Create new Status</h2>
                <Add_new_user endPoint="http://localhost:5000/api/statuss/" new_user_isShow={this.state.new_user_isShow} templateRenders={this.state.templateRenders} handleShowCreate={()=>this.handleShowCreate()}/>
                <hr/>
