...
class Products extends Component {
    state = { 
        ...
        users:[],
        templateRenders:[
            {type:"input",name:"name",range:"",value:""},
            {type:"input",name:"quantity",range:"",value:""},
    ...
    render() { 
        ...
        return ( 
            <div className="container">
                ...
                <Add_new_user endPoint="http://localhost:5000/api/products/" new_user_isShow={this.state.new_user_isShow} templateRenders={this.state.templateRenders} handleShowCreate={()=>this.handleShowCreate()}/>
                <hr/>
