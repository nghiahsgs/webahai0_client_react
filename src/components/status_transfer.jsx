...
class Status_transfer extends Component {
    state = { 
        new_user_isShow:false,
        
        users:[],
        templateRenders:[
            {type:"input",name:"text",range:"",value:""},
    ...
    render() { 
        ...
        return ( 
            <div className="container">
                <h2 className="text-center">Create new Status Transfer</h2>
                <Add_new_user endPoint="http://localhost:5000/api/status_transfers/" new_user_isShow={this.state.new_user_isShow} templateRenders={this.state.templateRenders} handleShowCreate={()=>this.handleShowCreate()}/>
                <hr/>
...
export default Status_transfer;